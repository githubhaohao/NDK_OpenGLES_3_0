...
#define SAMPLE_TYPE_KEY_PORTRAIT_MODE           SAMPLE_TYPE + 57
#define SAMPLE_TYPE_KEY_MSAA                    SAMPLE_TYPE + 58
#define SAMPLE_TYPE_KEY_FULLSCREEN_TRIANGLE     SAMPLE_TYPE + 59
#define SAMPLE_TYPE_KEY_GEOMETRY_SHADER         SAMPLE_TYPE + 60
#define SAMPLE_TYPE_KEY_GEOMETRY_SHADER2        SAMPLE_TYPE + 61
#define SAMPLE_TYPE_KEY_GEOMETRY_SHADER3        SAMPLE_TYPE + 62
