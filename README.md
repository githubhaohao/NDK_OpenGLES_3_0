...
[加载 3D 模型](https://www.jianshu.com/p/a07eaeb6824e)时，需要把整个 model 目录直接拷贝到手机文件根目录下(注意 Android Q 文件读写变化)，方便程序运行的时候加载模型及相关纹理，另外可以在文件 Model3DSample.cpp 中选择需要加载的模型。
